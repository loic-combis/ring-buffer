...
def test_initialization():
    ...
    buf = CupyRingBuffer(slots=5, dtype=cp.float64)
...
def test_basic_write_read_scalar():
    ...
    buf = CupyRingBuffer(slots=3, dtype=cp.float64)
...
def test_basic_write_read_1d():
    ...
    buf = CupyRingBuffer(slots=3, dtype=cp.float32, shape=(4,))
...
def test_basic_write_read_2d():
    ...
    buf = CupyRingBuffer(slots=3, dtype=cp.int32, shape=(2, 3))
...
def test_fill_to_capacity():
    ...
    capacity = 3
    buf = CupyRingBuffer(slots=capacity, dtype=cp.float64, shape=(2,))
...
def test_circular_wrap_around():
    ...
    capacity = 3
    buf = CupyRingBuffer(slots=capacity, dtype=cp.int32, shape=(2,))
...
def test_interleaved_write_read():
    ...
    buf = CupyRingBuffer(slots=2, dtype=cp.float64, shape=(3,))
...
def test_release_on_empty():
    ...
    buf = CupyRingBuffer(slots=2, dtype=cp.float64)
...
def test_read_without_release():
    ...
    buf = CupyRingBuffer(slots=2, dtype=cp.float64, shape=(2,))
...
def test_different_dtypes():
    ...
    for dtype in [cp.int8, cp.int16, cp.int32, cp.int64,
        ...
        buf = CupyRingBuffer(slots=2, dtype=dtype, shape=(3,))
...
def test_multiple_wrap_cycles():
    ...
    capacity = 3
    buf = CupyRingBuffer(slots=capacity, dtype=cp.int32)
...
def test_capacity_one():
    ...
    buf = CupyRingBuffer(slots=1, dtype=cp.float64, shape=(2,))
...
def test_complex_dtype():
    ...
    buf = CupyRingBuffer(slots=3, dtype=cp.complex128, shape=(2,))
...
def test_bool_dtype():
    ...
    buf = CupyRingBuffer(slots=3, dtype=cp.bool_, shape=(4,))
